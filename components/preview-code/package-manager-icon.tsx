...
export const PackageManagerIcon = ({ manager }: PackageManagerIconProps) => {
  switch (manager) {
    case "npm":
      return (
    ...
    case "pnpm":
      return (
        <svg viewBox="0 0 256 256" className="size-4">
          <path
            fill="#F9AD00"
            d="M0 0v85.498h85.498V0zm87.158 0v85.498h85.498V0zm87.158 0v85.498H256V0zM0 87.158v85.498h85.498V87.158zm87.158 0v85.498h85.498V87.158z"
          />
          <path
            fill="#4E4E4E"
            d="M174.316 87.158v85.498H256V87.158zM0 174.316V256h85.498v-81.684zm87.158 0V256h85.498v-81.684zm87.158 0V256H256v-81.684z"
          />
        </svg>
      );
    case "bun":
      return (
        <svg viewBox="0 0 80 70" className="size-4">
